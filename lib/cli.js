...
program
  ...
  .on('--help', function () {
    ...
    console.log('');
    console.log('  action, component, container, collection, method, publication, model, method-stub, module, skeleton');
    console.log('');
    console.log('  You need to provide module name for action, component, container, method-stub, and skeleton');
