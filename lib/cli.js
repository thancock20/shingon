...
program
  ...
  .on('--help', function () {
    ...
    console.log('');
    console.log('  action, component, container, collection, method, publication, model, method-stub, module');
    console.log('');
    console.log('  You need to provide module name for action, component, container, and method-stub');
