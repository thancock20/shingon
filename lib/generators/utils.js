...
export function getTemplatePath(type, options = {}) {
  ...
  if (options.testTemplate) {
    ...
    if (type === 'collection') {
      ...
      if (options.useClass) {
        if (options.useJss) {
          relativePath = '../../templates/client/modules/core/components/generic_class_jss.tt';
        } else {
          relativePath = `../../templates/client/modules/core/components/generic_class.tt`;
        }
      } else {
        if (options.useJss) {
          relativePath = '../../templates/client/modules/core/components/generic_stateless_jss.tt'
        } else {
