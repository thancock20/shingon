  ...
  if (options.testTemplate) {
    ...
    if (type === 'collection') {
      ...
      if (options.useClass) {
        ...
        relativePath = '../../templates/client/modules/core/components/generic_children.tt';
      } else {
...
export function getTemplateVaraibles(type, moduleName, fileName, options = {}) {
  if (type === 'component') {
    ...
    if (options.children) {
      ...
      variables.childrenImports = importsArray.join('\n');
      variables.childrenComponents = componentsArray.join('\n     ');
    }
