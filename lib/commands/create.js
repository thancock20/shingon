...
export default function create(appPath, options) {
  ...
  createFile(`${__dirname}/../../templates/client/modules/core/index.html`,
           `${appPath}/client/modules/core/index.html`);
  ...
  createFile(`${__dirname}/../../templates/gitignore.tt`,
          `${appPath}/.gitignore`);
  createFile(`${__dirname}/../../templates/settings-development.json`,
          `${appPath}/settings-development.json`);
  createFile(`${__dirname}/../../templates/settings-production.json`,
          `${appPath}/settings-production.json`);
