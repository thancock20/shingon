...
export default function create(appPath, options) {
  ...
  createFile(`${__dirname}/../../templates/client/styles/global.js`,
           `${appPath}/client/styles/global.js`);

  createFile(`${__dirname}/../../templates/lib/collections/index.js`,
           `${appPath}/lib/collections/index.js`);
  createFile(`${__dirname}/../../templates/lib/load_jss.js`,
           `${appPath}/lib/load_jss.js`);
