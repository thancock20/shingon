...
export default function create(appPath, options) {
  ...
  createFile(`${__dirname}/../../templates/client/styles/index.js`,
           `${appPath}/client/styles/index.js`);
  createFile(`${__dirname}/../../templates/client/styles/normalize.js`,
           `${appPath}/client/styles/normalize.js`);

  createFile(`${__dirname}/../../templates/lib/collections/index.js`,
           `${appPath}/lib/collections/index.js`);
  createFile(`${__dirname}/../../templates/lib/style_loader.js`,
           `${appPath}/lib/style_loader.js`);
  ...
  createDir(`${appPath}/.mantra`);
  createFile(`${__dirname}/../../templates/mantra_cli.yaml`,
          `${appPath}/mantra_cli.yaml`);
